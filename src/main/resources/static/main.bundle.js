...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__billing_billing_component__ = __webpack_require__("../../../../../src/app/billing/billing.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__billing_billing_module__ = __webpack_require__("../../../../../src/app/billing/billing.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_16__profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_12__login_login_service__["a" /* LoginService */]] },
    { path: 'restaurants', component: __WEBPACK_IMPORTED_MODULE_14__restaurant_restaurants_component__["a" /* RestaurantsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_12__login_login_service__["a" /* LoginService */]] },
    { path: 'billing', component: __WEBPACK_IMPORTED_MODULE_17__billing_billing_component__["a" /* BillingComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_12__login_login_service__["a" /* LoginService */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_13__login_login_component__["a" /* LoginComponent */] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_16__profile_profile_component__["a" /* ProfileComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_18__billing_billing_module__["a" /* BillingModule */],
...
/***/ "../../../../../src/app/billing/billing-details/billing-details.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"wrapper\">\n\n  <div class=\"orderTile\" *ngFor=\"let order of orders\" [ngClass]=\"theme.typeA\">\n\n    <div id=\"topRow\">\n      <span id=\"restaurantName\">{{order.restaurantName}}</span>\n      <span id=\"date\">{{order.date | date: 'dd.MM'}}</span>\n    </div>\n\n  </div>\n\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/billing/billing-details/billing-details.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/billing/billing-details/billing-details.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var BillingDetailsComponent = (function () {
    function BillingDetailsComponent(theme) {
        this.theme = theme;
    }
    BillingDetailsComponent.prototype.ngOnInit = function () {
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])('orders'),
        __metadata("design:type", Array)
    ], BillingDetailsComponent.prototype, "orders", void 0);
    BillingDetailsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-billing-details',
            template: __webpack_require__("../../../../../src/app/billing/billing-details/billing-details.component.html"),
            styles: [__webpack_require__("../../../../../src/app/billing/billing-details/billing-details.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__theme_theme_service__["a" /* ThemeService */]])
...
module.exports = "<div class=\"wrapper\" [ngClass]=\"theme.typeB\">\n\n  <div id=\"debtors\" [ngClass]=\"theme.typeC\">\n\n    <div class=\"header\">DEBTORS</div>\n\n    <div *ngFor=\"let orders of debtors\" [ngClass]=\"[theme.typeA, 'position']\" (mouseover)=\"setOrdersToShow(orders)\" (mouseleave)=\"setOrdersToShow(null)\">\n      <span class=\"name\">{{orders[0].userFirstName}} {{orders[0].userLastName}}</span>\n      <div class=\"tick\"><button mat-button>&#x2713;</button></div>\n      <span class=\"amount green\">{{ordersTotal(orders)}} PLN</span>\n    </div>\n\n  </div>\n\n  <div id=\"lenders\" [ngClass]=\"theme.typeC\">\n\n    <div class=\"header\">LENDERS</div>\n\n    <div *ngFor=\"let orders of lenders\"\n         [ngClass]=\"[theme.typeA, 'position']\" (mouseover)=\"setOrdersToShow(orders)\" (mouseleave)=\"setOrdersToShow(null)\">\n      <span class=\"name\">{{orders[0].userFirstName}} {{orders[0].userLastName}}</span>\n      <div class=\"tick\"><button mat-button>&#x2713;</button></div>\n      <div class=\"amount red\">{{ordersTotal(orders)}} PLN</div>\n    </div>\n\n  </div>\n\n  <app-billing-details *ngIf=\"ordersToShow\" [orders]=\"ordersToShow\"></app-billing-details>\n\n</div>\n\n\n"
...
// module
exports.push([module.i, ".pinkraze-a {\n  background: rgba(221, 174, 230, 0.97);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-b {\n  background: #5871ee;\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-c {\n  background: #3e5bb7;\n  color: rgba(227, 227, 227, 0.99); }\n\n.pinkraze-tile {\n  background: rgba(255, 255, 255, 0.93);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxB {\n  border: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxRightB {\n  border-right: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-font {\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-input {\n  border: none;\n  border-bottom: 1px solid rgba(227, 227, 227, 0.99);\n  color: rgba(227, 227, 227, 0.99);\n  background: none; }\n\n.red-a {\n  background: rgba(244, 76, 108, 0.99);\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-b {\n  background: white;\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-c {\n  background: rgba(180, 33, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.red-tile {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-border1px {\n  border: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-border1pxRight {\n  border-right: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-font {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.grass-a {\n  background: rgba(140, 226, 123, 0.99);\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-b {\n  background: white;\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-c {\n  background: rgba(93, 145, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.grass-tile {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-border1px {\n  border: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-border1pxRight {\n  border-right: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-font {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.blue-a {\n  background: rgba(108, 156, 231, 0.99);\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-b {\n  background: white;\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-c {\n  background: rgba(72, 112, 166, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.blue-tile {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-font {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n/**\r\n * The css property used for elevation. In most cases this should not be changed. It is exposed\r\n * as a variable for abstraction / easy use when needing to reference the property directly, for\r\n * example in a `will-change` rule.\r\n */\n/**\r\n * The default duration value for elevation transitions.\r\n */\n/**\r\n * The default easing value for elevation transitions.\r\n */\n/**\r\n * Applies the correct CSS rules to an element to give it the elevation specified by $z-value.\r\n * The $z-value must be between 0 and 24.\r\n * If $color has an alpha channel, it will be ignored and overridden. To increase the opacity of the shadow, use\r\n * $opacity-boost.\r\n */\n/**\r\n * Returns a string that can be used as the value for a `transition` property for elevation.\r\n * Calling this function directly is useful in situations where a component needs to transition\r\n * more than one property.\r\n *\r\n * ```scss\r\n * .foo {\r\n *   transition: mdc-elevation-transition-rule(), opacity 100ms ease;\r\n *   will-change: $mdc-elevation-property, opacity;\r\n * }\r\n * ```\r\n */\n/**\r\n * Applies the correct css rules needed to have an element transition between elevations.\r\n * This mixin should be applied to elements whose elevation values will change depending on their\r\n * context (e.g. when active or disabled).\r\n */\n.mdc-elevation--z0 {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z1 {\n  box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z2 {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z3 {\n  box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z4 {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z5 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 5px 8px 0px rgba(0, 0, 0, 0.14), 0px 1px 14px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z6 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z7 {\n  box-shadow: 0px 4px 5px -2px rgba(0, 0, 0, 0.2), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z8 {\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z9 {\n  box-shadow: 0px 5px 6px -3px rgba(0, 0, 0, 0.2), 0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 3px 16px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z10 {\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z11 {\n  box-shadow: 0px 6px 7px -4px rgba(0, 0, 0, 0.2), 0px 11px 15px 1px rgba(0, 0, 0, 0.14), 0px 4px 20px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z12 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 12px 17px 2px rgba(0, 0, 0, 0.14), 0px 5px 22px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z13 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 13px 19px 2px rgba(0, 0, 0, 0.14), 0px 5px 24px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z14 {\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z15 {\n  box-shadow: 0px 8px 9px -5px rgba(0, 0, 0, 0.2), 0px 15px 22px 2px rgba(0, 0, 0, 0.14), 0px 6px 28px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z16 {\n  box-shadow: 0px 8px 10px -5px rgba(0, 0, 0, 0.2), 0px 16px 24px 2px rgba(0, 0, 0, 0.14), 0px 6px 30px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z17 {\n  box-shadow: 0px 8px 11px -5px rgba(0, 0, 0, 0.2), 0px 17px 26px 2px rgba(0, 0, 0, 0.14), 0px 6px 32px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z18 {\n  box-shadow: 0px 9px 11px -5px rgba(0, 0, 0, 0.2), 0px 18px 28px 2px rgba(0, 0, 0, 0.14), 0px 7px 34px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z19 {\n  box-shadow: 0px 9px 12px -6px rgba(0, 0, 0, 0.2), 0px 19px 29px 2px rgba(0, 0, 0, 0.14), 0px 7px 36px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z20 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 20px 31px 3px rgba(0, 0, 0, 0.14), 0px 8px 38px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z21 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 21px 33px 3px rgba(0, 0, 0, 0.14), 0px 8px 40px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z22 {\n  box-shadow: 0px 10px 14px -6px rgba(0, 0, 0, 0.2), 0px 22px 35px 3px rgba(0, 0, 0, 0.14), 0px 8px 42px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z23 {\n  box-shadow: 0px 11px 14px -7px rgba(0, 0, 0, 0.2), 0px 23px 36px 3px rgba(0, 0, 0, 0.14), 0px 9px 44px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z24 {\n  box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation-transition {\n  transition: box-shadow 280ms cubic-bezier(0.4, 0, 0.2, 1);\n  will-change: box-shadow; }\n\n.grid {\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: (minmax(400px, 1fr))[auto-fill];\n      grid-template-columns: repeat(auto-fill, minmax(400px, 1fr));\n  grid-column-gap: 10px;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 130px;\n  margin: auto; }\n\n.slide-topright {\n  position: absolute;\n  top: 0;\n  right: -10px;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  z-index: 2; }\n\n.newElementButton {\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  right: 5vw;\n  bottom: 7vh;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  font-size: 70px;\n  border-radius: 100%;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none; }\n\n.newElementButton:active {\n  -webkit-transform: scale(0.97);\n          transform: scale(0.97); }\n\n.left {\n  float: left;\n  -webkit-transform: translateY(8px);\n          transform: translateY(8px); }\n\n.right {\n  float: right; }\n\n.tile {\n  width: 400px;\n  height: 120px;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 5px 30% 1fr;\n      grid-template-columns: 5px 30% 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  position: relative;\n  border-radius: 2px;\n  font-family: \"Lato\";\n  box-sizing: border-box; }\n  .tile img {\n    width: 100px;\n    height: 100px;\n    justify-self: center;\n    -ms-flex-item-align: center;\n        -ms-grid-row-align: center;\n        align-self: center; }\n  .tile #details {\n    justify-self: stretch;\n    -ms-flex-item-align: stretch;\n        -ms-grid-row-align: stretch;\n        align-self: stretch;\n    padding: 5px; }\n  .tile #restaurant {\n    margin: auto;\n    padding: 10px;\n    font-size: 21px;\n    font-weight: 600; }\n  .tile .element {\n    width: 90%; }\n\n.tile:hover, .newElementButton:hover {\n  cursor: pointer;\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1.012) translateZ(0);\n          transform: scale(1.012) translateZ(0); }\n\n.tile:active, .newElementButton:active {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1);\n          transform: scale(1); }\n\n.inactive {\n  pointer-events: none; }\n\n#close {\n  width: 105%;\n  height: 25px;\n  position: absolute;\n  right: 0;\n  bottom: 0px;\n  left: -10px;\n  margin: 10px auto 0;\n  font-size: 14px;\n  text-align: center; }\n  #close span {\n    position: relative;\n    top: -5px; }\n\n.wrapper {\n  width: 100%;\n  height: 100%;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 50% 50%;\n      grid-template-columns: 50% 50%;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  display: grid;\n  -ms-grid-rows: 1fr;\n      grid-template-rows: 1fr;\n  grid-row-gap: 0;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  position: relative;\n  min-height: 100%;\n  font-family: \"Lato\"; }\n\n#debtors, #lenders {\n  width: 70%;\n  height: 80%;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 1fr;\n      grid-template-columns: 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  display: grid;\n  -ms-grid-rows: 80px;\n      grid-template-rows: 80px;\n  grid-row-gap: 0;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  grid-auto-rows: 40px;\n  grid-row-gap: 10px;\n  border-radius: 2px; }\n\n.header {\n  font-size: 32px; }\n\n.position {\n  width: 90%;\n  height: 100%;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  border-radius: 2px;\n  box-sizing: border-box;\n  line-height: 40px;\n  padding-left: 20px;\n  padding-right: 25px;\n  font-size: 18px; }\n\n.name {\n  float: left; }\n\n.positionLabel, .amount, .tick {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n  line-height: 28px;\n  margin-top: 6px;\n  text-align: center;\n  float: right; }\n\n.amount {\n  height: 28px;\n  padding: 0 5px;\n  color: white; }\n\n.tick {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  width: 28px;\n  height: 28px;\n  box-sizing: border-box;\n  border-radius: 100%;\n  margin-left: 15px;\n  overflow: hidden;\n  display: -ms-grid;\n  display: grid; }\n  .tick button {\n    justify-self: center;\n    -ms-flex-item-align: center;\n        -ms-grid-row-align: center;\n        align-self: center;\n    -webkit-transform: translateX(-2px);\n            transform: translateX(-2px); }\n\n.red {\n  background-color: rgba(199, 73, 91, 0.92); }\n\n.green {\n  background-color: rgba(84, 163, 99, 0.89); }\n\napp-billing-details {\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  margin: auto;\n  width: 12%;\n  height: 80%;\n  min-height: 80%; }\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__theme_theme_service__ = __webpack_require__("../../../../../src/app/theme/theme.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__service_billing_service__ = __webpack_require__("../../../../../src/app/billing/service/billing.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BillingComponent = (function () {
    function BillingComponent(theme, billingService) {
        this.theme = theme;
    ...
    BillingComponent.prototype.fetchBilling = function () {
        var _this = this;
        this.billingService.getBilling().then(function (balance) {
            var debtors = new Map();
            var lenders = new Map();
            for (var _i = 0, _a = balance.orders_IMustGetPaid; _i < _a.length; _i++) {
                var ord = _a[_i];
                if (debtors.has(ord.userId))
                    debtors.get(ord.userId).push(ord);
                else
                    debtors.set(ord.userId, [ord]);
            }
            debtors.forEach(function (value, key) { return _this.debtors.push(value); });
            for (var _b = 0, _c = balance.orders_INeedToPay; _b < _c.length; _b++) {
                var ord = _c[_b];
                if (lenders.has(ord.userId))
                    lenders.get(ord.userId).push(ord);
                else
                    lenders.set(ord.userId, [ord]);
            }
            lenders.forEach(function (value, key) { return _this.lenders.push(value); });
        });
    };
    BillingComponent.prototype.ordersTotal = function (orders) {
        var sum = 0;
        for (var _i = 0, orders_1 = orders; _i < orders_1.length; _i++) {
            var order = orders_1[_i];
            for (var _a = 0, _b = order.dishes; _a < _b.length; _a++) {
                var dish = _b[_a];
                sum += dish.price;
            }
        }
    ...
    BillingComponent.prototype.setOrdersToShow = function (orders) {
    ...
    BillingComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            styles: [__webpack_require__("../../../../../src/app/billing/billing.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__theme_theme_service__["a" /* ThemeService */], __WEBPACK_IMPORTED_MODULE_2__service_billing_service__["a" /* BillingService */]])
    ], BillingComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__billing_component__ = __webpack_require__("../../../../../src/app/billing/billing.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__service_billing_service__ = __webpack_require__("../../../../../src/app/billing/service/billing.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_material__ = __webpack_require__("../../../material/esm5/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__billing_details_billing_details_component__ = __webpack_require__("../../../../../src/app/billing/billing-details/billing-details.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BillingModule = (function () {
    ...
    BillingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["K" /* NgModule */])({
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__billing_component__["a" /* BillingComponent */],
                __WEBPACK_IMPORTED_MODULE_5__billing_details_billing_details_component__["a" /* BillingDetailsComponent */]
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_3__service_billing_service__["a" /* BillingService */]]
        })
    ], BillingModule);
...
/***/ "../../../../../src/app/billing/service/billing.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var BillingService = (function () {
    function BillingService(http, loginService) {
        this.http = http;
    ...
    BillingService.prototype.getBilling = function () {
        ...
        return new Promise(function (resolve) {
            _this.http.get(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].apiHost + "/api/balance", _this.requestOptions()).subscribe(function (response) {
                resolve(response.json());
            });
        });
    };
    BillingService.prototype.requestOptions = function () {
...
// module
exports.push([module.i, ".pinkraze-a {\n  background: rgba(221, 174, 230, 0.97);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-b {\n  background: #5871ee;\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-c {\n  background: #3e5bb7;\n  color: rgba(227, 227, 227, 0.99); }\n\n.pinkraze-tile {\n  background: rgba(255, 255, 255, 0.93);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxB {\n  border: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxRightB {\n  border-right: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-font {\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-input {\n  border: none;\n  border-bottom: 1px solid rgba(227, 227, 227, 0.99);\n  color: rgba(227, 227, 227, 0.99);\n  background: none; }\n\n.red-a {\n  background: rgba(244, 76, 108, 0.99);\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-b {\n  background: white;\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-c {\n  background: rgba(180, 33, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.red-tile {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-border1px {\n  border: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-border1pxRight {\n  border-right: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-font {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.grass-a {\n  background: rgba(140, 226, 123, 0.99);\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-b {\n  background: white;\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-c {\n  background: rgba(93, 145, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.grass-tile {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-border1px {\n  border: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-border1pxRight {\n  border-right: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-font {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.blue-a {\n  background: rgba(108, 156, 231, 0.99);\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-b {\n  background: white;\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-c {\n  background: rgba(72, 112, 166, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.blue-tile {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-font {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n/**\r\n * The css property used for elevation. In most cases this should not be changed. It is exposed\r\n * as a variable for abstraction / easy use when needing to reference the property directly, for\r\n * example in a `will-change` rule.\r\n */\n/**\r\n * The default duration value for elevation transitions.\r\n */\n/**\r\n * The default easing value for elevation transitions.\r\n */\n/**\r\n * Applies the correct CSS rules to an element to give it the elevation specified by $z-value.\r\n * The $z-value must be between 0 and 24.\r\n * If $color has an alpha channel, it will be ignored and overridden. To increase the opacity of the shadow, use\r\n * $opacity-boost.\r\n */\n/**\r\n * Returns a string that can be used as the value for a `transition` property for elevation.\r\n * Calling this function directly is useful in situations where a component needs to transition\r\n * more than one property.\r\n *\r\n * ```scss\r\n * .foo {\r\n *   transition: mdc-elevation-transition-rule(), opacity 100ms ease;\r\n *   will-change: $mdc-elevation-property, opacity;\r\n * }\r\n * ```\r\n */\n/**\r\n * Applies the correct css rules needed to have an element transition between elevations.\r\n * This mixin should be applied to elements whose elevation values will change depending on their\r\n * context (e.g. when active or disabled).\r\n */\n.mdc-elevation--z0 {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z1 {\n  box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z2 {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z3 {\n  box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z4 {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z5 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 5px 8px 0px rgba(0, 0, 0, 0.14), 0px 1px 14px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z6 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z7 {\n  box-shadow: 0px 4px 5px -2px rgba(0, 0, 0, 0.2), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z8 {\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z9 {\n  box-shadow: 0px 5px 6px -3px rgba(0, 0, 0, 0.2), 0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 3px 16px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z10 {\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z11 {\n  box-shadow: 0px 6px 7px -4px rgba(0, 0, 0, 0.2), 0px 11px 15px 1px rgba(0, 0, 0, 0.14), 0px 4px 20px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z12 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 12px 17px 2px rgba(0, 0, 0, 0.14), 0px 5px 22px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z13 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 13px 19px 2px rgba(0, 0, 0, 0.14), 0px 5px 24px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z14 {\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z15 {\n  box-shadow: 0px 8px 9px -5px rgba(0, 0, 0, 0.2), 0px 15px 22px 2px rgba(0, 0, 0, 0.14), 0px 6px 28px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z16 {\n  box-shadow: 0px 8px 10px -5px rgba(0, 0, 0, 0.2), 0px 16px 24px 2px rgba(0, 0, 0, 0.14), 0px 6px 30px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z17 {\n  box-shadow: 0px 8px 11px -5px rgba(0, 0, 0, 0.2), 0px 17px 26px 2px rgba(0, 0, 0, 0.14), 0px 6px 32px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z18 {\n  box-shadow: 0px 9px 11px -5px rgba(0, 0, 0, 0.2), 0px 18px 28px 2px rgba(0, 0, 0, 0.14), 0px 7px 34px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z19 {\n  box-shadow: 0px 9px 12px -6px rgba(0, 0, 0, 0.2), 0px 19px 29px 2px rgba(0, 0, 0, 0.14), 0px 7px 36px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z20 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 20px 31px 3px rgba(0, 0, 0, 0.14), 0px 8px 38px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z21 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 21px 33px 3px rgba(0, 0, 0, 0.14), 0px 8px 40px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z22 {\n  box-shadow: 0px 10px 14px -6px rgba(0, 0, 0, 0.2), 0px 22px 35px 3px rgba(0, 0, 0, 0.14), 0px 8px 42px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z23 {\n  box-shadow: 0px 11px 14px -7px rgba(0, 0, 0, 0.2), 0px 23px 36px 3px rgba(0, 0, 0, 0.14), 0px 9px 44px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z24 {\n  box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation-transition {\n  transition: box-shadow 280ms cubic-bezier(0.4, 0, 0.2, 1);\n  will-change: box-shadow; }\n\n.grid {\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: (minmax(400px, 1fr))[auto-fill];\n      grid-template-columns: repeat(auto-fill, minmax(400px, 1fr));\n  grid-column-gap: 10px;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 130px;\n  margin: auto; }\n\n.slide-topright {\n  position: absolute;\n  top: 0;\n  right: -10px;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  z-index: 2; }\n\n.newElementButton {\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  right: 5vw;\n  bottom: 7vh;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  font-size: 70px;\n  border-radius: 100%;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none; }\n\n.newElementButton:active {\n  -webkit-transform: scale(0.97);\n          transform: scale(0.97); }\n\n.left {\n  float: left;\n  -webkit-transform: translateY(8px);\n          transform: translateY(8px); }\n\n.right {\n  float: right; }\n\n.tile {\n  width: 400px;\n  height: 120px;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 5px 30% 1fr;\n      grid-template-columns: 5px 30% 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  position: relative;\n  border-radius: 2px;\n  font-family: \"Lato\";\n  box-sizing: border-box; }\n  .tile img {\n    width: 100px;\n    height: 100px;\n    justify-self: center;\n    -ms-flex-item-align: center;\n        -ms-grid-row-align: center;\n        align-self: center; }\n  .tile #details {\n    justify-self: stretch;\n    -ms-flex-item-align: stretch;\n        -ms-grid-row-align: stretch;\n        align-self: stretch;\n    padding: 5px; }\n  .tile #restaurant {\n    margin: auto;\n    padding: 10px;\n    font-size: 21px;\n    font-weight: 600; }\n  .tile .element {\n    width: 90%; }\n\n.tile:hover, .newElementButton:hover {\n  cursor: pointer;\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1.012) translateZ(0);\n          transform: scale(1.012) translateZ(0); }\n\n.tile:active, .newElementButton:active {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1);\n          transform: scale(1); }\n\n.inactive {\n  pointer-events: none; }\n\n#close {\n  width: 105%;\n  height: 25px;\n  position: absolute;\n  right: 0;\n  bottom: 0px;\n  left: -10px;\n  margin: 10px auto 0;\n  font-size: 14px;\n  text-align: center; }\n  #close span {\n    position: relative;\n    top: -5px; }\n\n.wrapper {\n  width: 100%;\n  height: 100%;\n  font-family: \"Lato\"; }\n\n#loginBox {\n  width: 380px;\n  height: 100%;\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center; }\n\n#back {\n  width: 460px;\n  height: 240px;\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  margin: auto;\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\n  border-radius: 2px; }\n\n#username, #password, #buttons {\n  width: 100%;\n  height: 45px;\n  box-sizing: border-box;\n  background: transparent; }\n\n#buttons {\n  margin-top: 5px; }\n\n#username, #password {\n  font-size: 16px;\n  text-align: center;\n  width: 320px; }\n\n#username {\n  margin-top: 20px; }\n\n#buttons button {\n  width: 48%;\n  height: 45px;\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  font-size: 16px; }\n\n#login {\n  float: left; }\n\n#register {\n  float: right; }\n\n.round {\n  border-radius: 2px; }\n\n.invalid {\n  background-color: rgba(255, 15, 44, 0.28); }\n", ""]);
...
module.exports = "<div class=\"wrapper\" [ngClass]=\"theme.typeB\">\r\n\r\n  <div id=\"box\" [ngClass]=\"[theme.typeC]\">\r\n\r\n    <div class=\"header\" *ngIf=\"!loginService.logged\">CREATE ACCOUNT</div>\r\n    <div class=\"header\" *ngIf=\"loginService.logged\">EDIT PROFILE</div>\r\n\r\n    <div class=\"filler\"></div>\r\n\r\n    <div id=\"fields\">\r\n\r\n      <div id=\"leftColumn\">\r\n\r\n        <div *ngFor=\"let field of leftColumn\" class=\"position\"><span>{{field.label}}</span>\r\n          <input type=\"text\" [ngClass]=\"theme.input\" [(ngModel)]=\"user[field.binding]\"/>\r\n        </div>\r\n\r\n      </div>\r\n\r\n      <div id=\"rightColumn\">\r\n\r\n        <div *ngFor=\"let field of rightColumn\" class=\"position\"><span>{{field.label}}</span>\r\n          <input type=\"text\" [ngClass]=\"theme.input\" [(ngModel)]=\"user[field.binding]\"/>\r\n        </div>\r\n\r\n      </div>\r\n\r\n      <div id=\"buttonBox\">\r\n\r\n        <button mat-button *ngIf=\"!loginService.logged\" [ngClass]=\"theme.typeA\" (click)=\"register()\">CREATE ACCOUNT</button>\r\n        <button mat-button *ngIf=\"loginService.logged\" [ngClass]=\"theme.typeA\">SAVE CHANGES</button>\r\n      </div>\r\n\r\n    </div>\r\n\r\n  </div>\r\n\r\n  <button mat-button id=\"logoutButton\" *ngIf=\"loginService.logged\" [ngClass]=\"theme.typeA\" (click)=\"logout()\">LOGOUT</button>\r\n\r\n</div>\r\n"
...
// module
exports.push([module.i, ".pinkraze-a {\n  background: rgba(221, 174, 230, 0.97);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-b {\n  background: #5871ee;\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-c {\n  background: #3e5bb7;\n  color: rgba(227, 227, 227, 0.99); }\n\n.pinkraze-tile {\n  background: rgba(255, 255, 255, 0.93);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxB {\n  border: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxRightB {\n  border-right: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-font {\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-input {\n  border: none;\n  border-bottom: 1px solid rgba(227, 227, 227, 0.99);\n  color: rgba(227, 227, 227, 0.99);\n  background: none; }\n\n.red-a {\n  background: rgba(244, 76, 108, 0.99);\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-b {\n  background: white;\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-c {\n  background: rgba(180, 33, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.red-tile {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-border1px {\n  border: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-border1pxRight {\n  border-right: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-font {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.grass-a {\n  background: rgba(140, 226, 123, 0.99);\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-b {\n  background: white;\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-c {\n  background: rgba(93, 145, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.grass-tile {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-border1px {\n  border: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-border1pxRight {\n  border-right: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-font {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.blue-a {\n  background: rgba(108, 156, 231, 0.99);\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-b {\n  background: white;\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-c {\n  background: rgba(72, 112, 166, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.blue-tile {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-font {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n/**\r\n * The css property used for elevation. In most cases this should not be changed. It is exposed\r\n * as a variable for abstraction / easy use when needing to reference the property directly, for\r\n * example in a `will-change` rule.\r\n */\n/**\r\n * The default duration value for elevation transitions.\r\n */\n/**\r\n * The default easing value for elevation transitions.\r\n */\n/**\r\n * Applies the correct CSS rules to an element to give it the elevation specified by $z-value.\r\n * The $z-value must be between 0 and 24.\r\n * If $color has an alpha channel, it will be ignored and overridden. To increase the opacity of the shadow, use\r\n * $opacity-boost.\r\n */\n/**\r\n * Returns a string that can be used as the value for a `transition` property for elevation.\r\n * Calling this function directly is useful in situations where a component needs to transition\r\n * more than one property.\r\n *\r\n * ```scss\r\n * .foo {\r\n *   transition: mdc-elevation-transition-rule(), opacity 100ms ease;\r\n *   will-change: $mdc-elevation-property, opacity;\r\n * }\r\n * ```\r\n */\n/**\r\n * Applies the correct css rules needed to have an element transition between elevations.\r\n * This mixin should be applied to elements whose elevation values will change depending on their\r\n * context (e.g. when active or disabled).\r\n */\n.mdc-elevation--z0 {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z1 {\n  box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z2 {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z3 {\n  box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z4 {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z5 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 5px 8px 0px rgba(0, 0, 0, 0.14), 0px 1px 14px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z6 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z7 {\n  box-shadow: 0px 4px 5px -2px rgba(0, 0, 0, 0.2), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z8 {\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z9 {\n  box-shadow: 0px 5px 6px -3px rgba(0, 0, 0, 0.2), 0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 3px 16px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z10 {\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z11 {\n  box-shadow: 0px 6px 7px -4px rgba(0, 0, 0, 0.2), 0px 11px 15px 1px rgba(0, 0, 0, 0.14), 0px 4px 20px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z12 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 12px 17px 2px rgba(0, 0, 0, 0.14), 0px 5px 22px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z13 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 13px 19px 2px rgba(0, 0, 0, 0.14), 0px 5px 24px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z14 {\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z15 {\n  box-shadow: 0px 8px 9px -5px rgba(0, 0, 0, 0.2), 0px 15px 22px 2px rgba(0, 0, 0, 0.14), 0px 6px 28px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z16 {\n  box-shadow: 0px 8px 10px -5px rgba(0, 0, 0, 0.2), 0px 16px 24px 2px rgba(0, 0, 0, 0.14), 0px 6px 30px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z17 {\n  box-shadow: 0px 8px 11px -5px rgba(0, 0, 0, 0.2), 0px 17px 26px 2px rgba(0, 0, 0, 0.14), 0px 6px 32px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z18 {\n  box-shadow: 0px 9px 11px -5px rgba(0, 0, 0, 0.2), 0px 18px 28px 2px rgba(0, 0, 0, 0.14), 0px 7px 34px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z19 {\n  box-shadow: 0px 9px 12px -6px rgba(0, 0, 0, 0.2), 0px 19px 29px 2px rgba(0, 0, 0, 0.14), 0px 7px 36px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z20 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 20px 31px 3px rgba(0, 0, 0, 0.14), 0px 8px 38px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z21 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 21px 33px 3px rgba(0, 0, 0, 0.14), 0px 8px 40px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z22 {\n  box-shadow: 0px 10px 14px -6px rgba(0, 0, 0, 0.2), 0px 22px 35px 3px rgba(0, 0, 0, 0.14), 0px 8px 42px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z23 {\n  box-shadow: 0px 11px 14px -7px rgba(0, 0, 0, 0.2), 0px 23px 36px 3px rgba(0, 0, 0, 0.14), 0px 9px 44px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z24 {\n  box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation-transition {\n  transition: box-shadow 280ms cubic-bezier(0.4, 0, 0.2, 1);\n  will-change: box-shadow; }\n\n.grid {\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: (minmax(400px, 1fr))[auto-fill];\n      grid-template-columns: repeat(auto-fill, minmax(400px, 1fr));\n  grid-column-gap: 10px;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 130px;\n  margin: auto; }\n\n.slide-topright {\n  position: absolute;\n  top: 0;\n  right: -10px;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  z-index: 2; }\n\n.newElementButton {\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  right: 5vw;\n  bottom: 7vh;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  font-size: 70px;\n  border-radius: 100%;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none; }\n\n.newElementButton:active {\n  -webkit-transform: scale(0.97);\n          transform: scale(0.97); }\n\n.left {\n  float: left;\n  -webkit-transform: translateY(8px);\n          transform: translateY(8px); }\n\n.right {\n  float: right; }\n\n.tile {\n  width: 400px;\n  height: 120px;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 5px 30% 1fr;\n      grid-template-columns: 5px 30% 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  position: relative;\n  border-radius: 2px;\n  font-family: \"Lato\";\n  box-sizing: border-box; }\n  .tile img {\n    width: 100px;\n    height: 100px;\n    justify-self: center;\n    -ms-flex-item-align: center;\n        -ms-grid-row-align: center;\n        align-self: center; }\n  .tile #details {\n    justify-self: stretch;\n    -ms-flex-item-align: stretch;\n        -ms-grid-row-align: stretch;\n        align-self: stretch;\n    padding: 5px; }\n  .tile #restaurant {\n    margin: auto;\n    padding: 10px;\n    font-size: 21px;\n    font-weight: 600; }\n  .tile .element {\n    width: 90%; }\n\n.tile:hover, .newElementButton:hover {\n  cursor: pointer;\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1.012) translateZ(0);\n          transform: scale(1.012) translateZ(0); }\n\n.tile:active, .newElementButton:active {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1);\n          transform: scale(1); }\n\n.inactive {\n  pointer-events: none; }\n\n#close {\n  width: 105%;\n  height: 25px;\n  position: absolute;\n  right: 0;\n  bottom: 0px;\n  left: -10px;\n  margin: 10px auto 0;\n  font-size: 14px;\n  text-align: center; }\n  #close span {\n    position: relative;\n    top: -5px; }\n\n.wrapper {\n  width: 100%;\n  height: 100%; }\n\n#box {\n  width: 50vw;\n  height: 50vh;\n  min-width: 600px;\n  min-height: 500px;\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  margin: auto;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 1fr;\n      grid-template-columns: 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  display: grid;\n  -ms-grid-rows: 100px 30px 1fr;\n      grid-template-rows: 100px 30px 1fr;\n  grid-row-gap: 0;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  font-family: \"Lato\";\n  grid-auto-rows: 50px;\n  border-radius: 2px; }\n\n.header {\n  font-size: 25px; }\n\n#fields {\n  width: 100%;\n  height: 100%;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 1fr 1fr;\n      grid-template-columns: 1fr 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: stretch;\n      justify-items: stretch;\n  display: grid;\n  -ms-grid-rows: 1fr 20% 10%;\n      grid-template-rows: 1fr 20% 10%;\n  grid-row-gap: 0;\n  -webkit-box-align: stretch;\n      -ms-flex-align: stretch;\n          align-items: stretch;\n  grid-template-areas: \"left right\" \"button button\" \"bottom bottom\"; }\n\n#leftColumn {\n  grid-area: left; }\n\n#rightColumn {\n  grid-area: right; }\n\n#leftColumn, #rightColumn {\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 40px;\n  grid-row-gap: 10px; }\n\n#buttonBox {\n  grid-area: button;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 1fr;\n      grid-template-columns: 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  display: grid;\n  -ms-grid-rows: 1fr;\n      grid-template-rows: 1fr;\n  grid-row-gap: 0;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center; }\n  #buttonBox button {\n    width: 60%;\n    height: 35px;\n    box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.position {\n  width: 80%;\n  height: 100%; }\n  .position span {\n    float: left; }\n  .position input {\n    width: 60%;\n    float: right; }\n\n#logoutButton {\n  width: 120px;\n  height: 35px;\n  position: absolute;\n  top: 80px;\n  right: 80px;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n", ""]);
...
// module
exports.push([module.i, ".pinkraze-a {\n  background: rgba(221, 174, 230, 0.97);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-b {\n  background: #5871ee;\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-c {\n  background: #3e5bb7;\n  color: rgba(227, 227, 227, 0.99); }\n\n.pinkraze-tile {\n  background: rgba(255, 255, 255, 0.93);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxB {\n  border: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxRightB {\n  border-right: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-font {\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-input {\n  border: none;\n  border-bottom: 1px solid rgba(227, 227, 227, 0.99);\n  color: rgba(227, 227, 227, 0.99);\n  background: none; }\n\n.red-a {\n  background: rgba(244, 76, 108, 0.99);\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-b {\n  background: white;\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-c {\n  background: rgba(180, 33, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.red-tile {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-border1px {\n  border: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-border1pxRight {\n  border-right: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-font {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.grass-a {\n  background: rgba(140, 226, 123, 0.99);\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-b {\n  background: white;\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-c {\n  background: rgba(93, 145, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.grass-tile {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-border1px {\n  border: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-border1pxRight {\n  border-right: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-font {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.blue-a {\n  background: rgba(108, 156, 231, 0.99);\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-b {\n  background: white;\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-c {\n  background: rgba(72, 112, 166, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.blue-tile {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-font {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n/**\r\n * The css property used for elevation. In most cases this should not be changed. It is exposed\r\n * as a variable for abstraction / easy use when needing to reference the property directly, for\r\n * example in a `will-change` rule.\r\n */\n/**\r\n * The default duration value for elevation transitions.\r\n */\n/**\r\n * The default easing value for elevation transitions.\r\n */\n/**\r\n * Applies the correct CSS rules to an element to give it the elevation specified by $z-value.\r\n * The $z-value must be between 0 and 24.\r\n * If $color has an alpha channel, it will be ignored and overridden. To increase the opacity of the shadow, use\r\n * $opacity-boost.\r\n */\n/**\r\n * Returns a string that can be used as the value for a `transition` property for elevation.\r\n * Calling this function directly is useful in situations where a component needs to transition\r\n * more than one property.\r\n *\r\n * ```scss\r\n * .foo {\r\n *   transition: mdc-elevation-transition-rule(), opacity 100ms ease;\r\n *   will-change: $mdc-elevation-property, opacity;\r\n * }\r\n * ```\r\n */\n/**\r\n * Applies the correct css rules needed to have an element transition between elevations.\r\n * This mixin should be applied to elements whose elevation values will change depending on their\r\n * context (e.g. when active or disabled).\r\n */\n.mdc-elevation--z0 {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z1 {\n  box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z2 {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z3 {\n  box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z4 {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z5 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 5px 8px 0px rgba(0, 0, 0, 0.14), 0px 1px 14px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z6 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z7 {\n  box-shadow: 0px 4px 5px -2px rgba(0, 0, 0, 0.2), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z8 {\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z9 {\n  box-shadow: 0px 5px 6px -3px rgba(0, 0, 0, 0.2), 0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 3px 16px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z10 {\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z11 {\n  box-shadow: 0px 6px 7px -4px rgba(0, 0, 0, 0.2), 0px 11px 15px 1px rgba(0, 0, 0, 0.14), 0px 4px 20px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z12 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 12px 17px 2px rgba(0, 0, 0, 0.14), 0px 5px 22px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z13 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 13px 19px 2px rgba(0, 0, 0, 0.14), 0px 5px 24px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z14 {\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z15 {\n  box-shadow: 0px 8px 9px -5px rgba(0, 0, 0, 0.2), 0px 15px 22px 2px rgba(0, 0, 0, 0.14), 0px 6px 28px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z16 {\n  box-shadow: 0px 8px 10px -5px rgba(0, 0, 0, 0.2), 0px 16px 24px 2px rgba(0, 0, 0, 0.14), 0px 6px 30px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z17 {\n  box-shadow: 0px 8px 11px -5px rgba(0, 0, 0, 0.2), 0px 17px 26px 2px rgba(0, 0, 0, 0.14), 0px 6px 32px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z18 {\n  box-shadow: 0px 9px 11px -5px rgba(0, 0, 0, 0.2), 0px 18px 28px 2px rgba(0, 0, 0, 0.14), 0px 7px 34px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z19 {\n  box-shadow: 0px 9px 12px -6px rgba(0, 0, 0, 0.2), 0px 19px 29px 2px rgba(0, 0, 0, 0.14), 0px 7px 36px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z20 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 20px 31px 3px rgba(0, 0, 0, 0.14), 0px 8px 38px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z21 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 21px 33px 3px rgba(0, 0, 0, 0.14), 0px 8px 40px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z22 {\n  box-shadow: 0px 10px 14px -6px rgba(0, 0, 0, 0.2), 0px 22px 35px 3px rgba(0, 0, 0, 0.14), 0px 8px 42px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z23 {\n  box-shadow: 0px 11px 14px -7px rgba(0, 0, 0, 0.2), 0px 23px 36px 3px rgba(0, 0, 0, 0.14), 0px 9px 44px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z24 {\n  box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation-transition {\n  transition: box-shadow 280ms cubic-bezier(0.4, 0, 0.2, 1);\n  will-change: box-shadow; }\n\n.grid {\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: (minmax(400px, 1fr))[auto-fill];\n      grid-template-columns: repeat(auto-fill, minmax(400px, 1fr));\n  grid-column-gap: 10px;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 130px;\n  margin: auto; }\n\n.slide-topright {\n  position: absolute;\n  top: 0;\n  right: -10px;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  z-index: 2; }\n\n.newElementButton {\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  right: 5vw;\n  bottom: 7vh;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  font-size: 70px;\n  border-radius: 100%;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none; }\n\n.newElementButton:active {\n  -webkit-transform: scale(0.97);\n          transform: scale(0.97); }\n\n.left {\n  float: left;\n  -webkit-transform: translateY(8px);\n          transform: translateY(8px); }\n\n.right {\n  float: right; }\n\n.tile {\n  width: 400px;\n  height: 120px;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 5px 30% 1fr;\n      grid-template-columns: 5px 30% 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  position: relative;\n  border-radius: 2px;\n  font-family: \"Lato\";\n  box-sizing: border-box; }\n  .tile img {\n    width: 100px;\n    height: 100px;\n    justify-self: center;\n    -ms-flex-item-align: center;\n        -ms-grid-row-align: center;\n        align-self: center; }\n  .tile #details {\n    justify-self: stretch;\n    -ms-flex-item-align: stretch;\n        -ms-grid-row-align: stretch;\n        align-self: stretch;\n    padding: 5px; }\n  .tile #restaurant {\n    margin: auto;\n    padding: 10px;\n    font-size: 21px;\n    font-weight: 600; }\n  .tile .element {\n    width: 90%; }\n\n.tile:hover, .newElementButton:hover {\n  cursor: pointer;\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1.012) translateZ(0);\n          transform: scale(1.012) translateZ(0); }\n\n.tile:active, .newElementButton:active {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1);\n          transform: scale(1); }\n\n.inactive {\n  pointer-events: none; }\n\n#close {\n  width: 105%;\n  height: 25px;\n  position: absolute;\n  right: 0;\n  bottom: 0px;\n  left: -10px;\n  margin: 10px auto 0;\n  font-size: 14px;\n  text-align: center; }\n  #close span {\n    position: relative;\n    top: -5px; }\n\n#frame {\n  width: 450px;\n  height: 650px;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-rows: 40px 140px 1fr;\n      grid-template-rows: 40px 140px 1fr;\n  grid-row-gap: 10px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-align: stretch;\n      -ms-flex-align: stretch;\n          align-items: stretch;\n  position: relative;\n  margin: auto;\n  padding-bottom: 15px;\n  border-radius: 2px;\n  font-family: \"Lato\";\n  font-size: 20px;\n  overflow: hidden; }\n\n#info {\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 60% 1fr;\n      grid-template-columns: 60% 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: stretch;\n      justify-items: stretch;\n  display: grid;\n  -ms-grid-rows: 50% 1fr;\n      grid-template-rows: 50% 1fr;\n  grid-row-gap: 0;\n  -webkit-box-align: stretch;\n      -ms-flex-align: stretch;\n          align-items: stretch;\n  justify-self: center;\n  -ms-grid-row-align: center;\n      align-self: center;\n  width: 88%;\n  margin-bottom: 10px; }\n\n#restaurantName {\n  font-size: 32px;\n  margin-bottom: 10px;\n  grid-column: 1 / 3; }\n\n#restaurantDetails {\n  -ms-grid-row: 2;\n      grid-row: 2;\n  -ms-grid-column: 1;\n      grid-column: 1;\n  padding: 3px;\n  font-size: 15px; }\n\n.detail {\n  height: 20px; }\n\n#avgTime {\n  -ms-grid-row: 2;\n      grid-row: 2;\n  -ms-grid-column: 2;\n      grid-column: 2;\n  font-size: 20px;\n  -webkit-transform: translateY(7px);\n          transform: translateY(7px); }\n\n#menu {\n  justify-self: center;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-rows: 50px 20px 350px;\n      grid-template-rows: 50px 20px 350px;\n  grid-row-gap: 1fr;\n  width: 88%;\n  overflow: hidden; }\n\n#scrollBox {\n  width: 100%;\n  height: 100%;\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 30px;\n  overflow-y: scroll;\n  padding-right: 12px; }\n\n#topRow {\n  width: 100%; }\n\n#menuLabel {\n  width: 30%;\n  height: 100%;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-rows: 1fr;\n      grid-template-rows: 1fr;\n  grid-row-gap: 0;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  float: left;\n  font-size: 28px; }\n\n#addDish {\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-columns: 140px 50px 40px;\n      grid-template-columns: 140px 50px 40px;\n  grid-column-gap: 10px;\n  height: 100%;\n  float: right;\n  margin-right: 10px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center; }\n  #addDish input, #addDish button {\n    height: 35px;\n    box-sizing: border-box; }\n  #addDish input {\n    padding-left: 5px;\n    background: transparent; }\n  #addDish button {\n    display: -ms-grid;\n    display: grid;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    -ms-grid-column-align: center;\n        justify-items: center;\n    box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n    box-sizing: border-box;\n    font-size: 18px;\n    font-weight: 700;\n    border-radius: 2px; }\n\n.menuPosition {\n  width: 100%;\n  height: 100%; }\n\n.dishName {\n  float: left; }\n\n.dishPrice {\n  float: right;\n  -webkit-transform: translateX(-10px);\n          transform: translateX(-10px); }\n", ""]);
...
var RestaurantDetailsComponent = (function () {
    ...
    RestaurantDetailsComponent.prototype.addDish = function () {
        ...
        this.service.addDish(dish).then(function (result) {
            if (result) {
                _this.refresh.emit(true);
                _this.dishInput = '';
                _this.dishPriceInput = '';
            }
        });
    };
    __decorate([
...
var RestaurantService = (function () {
    ...
    RestaurantService.prototype.addDish = function (dish) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.put(__WEBPACK_IMPORTED_MODULE_2__environments_environment__["a" /* environment */].apiHost + "/api/restaurant/dish/save", dish, _this.requestOptions()).subscribe(function (response) {
                resolve(response.json().status === 'success');
            });
        });
    };
...
// module
exports.push([module.i, ".pinkraze-a {\n  background: rgba(221, 174, 230, 0.97);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-b {\n  background: #5871ee;\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-c {\n  background: #3e5bb7;\n  color: rgba(227, 227, 227, 0.99); }\n\n.pinkraze-tile {\n  background: rgba(255, 255, 255, 0.93);\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxB {\n  border: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.81); }\n\n.pinkraze-border1pxRightB {\n  border-right: solid 1px rgba(227, 227, 227, 0.99); }\n\n.pinkraze-font {\n  color: rgba(43, 43, 43, 0.81); }\n\n.pinkraze-input {\n  border: none;\n  border-bottom: 1px solid rgba(227, 227, 227, 0.99);\n  color: rgba(227, 227, 227, 0.99);\n  background: none; }\n\n.red-a {\n  background: rgba(244, 76, 108, 0.99);\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-b {\n  background: white;\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-c {\n  background: rgba(180, 33, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.red-tile {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-border1px {\n  border: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-border1pxRight {\n  border-right: solid 1px rgba(40, 40, 40, 0.95); }\n\n.red-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.red-font {\n  color: rgba(40, 40, 40, 0.95); }\n\n.red-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.grass-a {\n  background: rgba(140, 226, 123, 0.99);\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-b {\n  background: white;\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-c {\n  background: rgba(93, 145, 71, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.grass-tile {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-border1px {\n  border: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-border1pxRight {\n  border-right: solid 1px rgba(58, 58, 58, 0.95); }\n\n.grass-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.grass-font {\n  color: rgba(58, 58, 58, 0.95); }\n\n.grass-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n.blue-a {\n  background: rgba(108, 156, 231, 0.99);\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-b {\n  background: white;\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-c {\n  background: rgba(72, 112, 166, 0.99);\n  color: rgba(248, 248, 248, 0.99); }\n\n.blue-tile {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-border1px {\n  border: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxB {\n  border: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-border1pxRight {\n  border-right: solid 1px rgba(43, 43, 43, 0.95); }\n\n.blue-border1pxRightB {\n  border-right: solid 1px rgba(248, 248, 248, 0.99); }\n\n.blue-font {\n  color: rgba(43, 43, 43, 0.95); }\n\n.blue-input {\n  border: none;\n  border-bottom: 1px solid rgba(248, 248, 248, 0.99);\n  color: rgba(248, 248, 248, 0.99);\n  background: none; }\n\n/**\r\n * The css property used for elevation. In most cases this should not be changed. It is exposed\r\n * as a variable for abstraction / easy use when needing to reference the property directly, for\r\n * example in a `will-change` rule.\r\n */\n/**\r\n * The default duration value for elevation transitions.\r\n */\n/**\r\n * The default easing value for elevation transitions.\r\n */\n/**\r\n * Applies the correct CSS rules to an element to give it the elevation specified by $z-value.\r\n * The $z-value must be between 0 and 24.\r\n * If $color has an alpha channel, it will be ignored and overridden. To increase the opacity of the shadow, use\r\n * $opacity-boost.\r\n */\n/**\r\n * Returns a string that can be used as the value for a `transition` property for elevation.\r\n * Calling this function directly is useful in situations where a component needs to transition\r\n * more than one property.\r\n *\r\n * ```scss\r\n * .foo {\r\n *   transition: mdc-elevation-transition-rule(), opacity 100ms ease;\r\n *   will-change: $mdc-elevation-property, opacity;\r\n * }\r\n * ```\r\n */\n/**\r\n * Applies the correct css rules needed to have an element transition between elevations.\r\n * This mixin should be applied to elements whose elevation values will change depending on their\r\n * context (e.g. when active or disabled).\r\n */\n.mdc-elevation--z0 {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z1 {\n  box-shadow: 0px 2px 1px -1px rgba(0, 0, 0, 0.2), 0px 1px 1px 0px rgba(0, 0, 0, 0.14), 0px 1px 3px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z2 {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z3 {\n  box-shadow: 0px 3px 3px -2px rgba(0, 0, 0, 0.2), 0px 3px 4px 0px rgba(0, 0, 0, 0.14), 0px 1px 8px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z4 {\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z5 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 5px 8px 0px rgba(0, 0, 0, 0.14), 0px 1px 14px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z6 {\n  box-shadow: 0px 3px 5px -1px rgba(0, 0, 0, 0.2), 0px 6px 10px 0px rgba(0, 0, 0, 0.14), 0px 1px 18px 0px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z7 {\n  box-shadow: 0px 4px 5px -2px rgba(0, 0, 0, 0.2), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z8 {\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z9 {\n  box-shadow: 0px 5px 6px -3px rgba(0, 0, 0, 0.2), 0px 9px 12px 1px rgba(0, 0, 0, 0.14), 0px 3px 16px 2px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z10 {\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z11 {\n  box-shadow: 0px 6px 7px -4px rgba(0, 0, 0, 0.2), 0px 11px 15px 1px rgba(0, 0, 0, 0.14), 0px 4px 20px 3px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z12 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 12px 17px 2px rgba(0, 0, 0, 0.14), 0px 5px 22px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z13 {\n  box-shadow: 0px 7px 8px -4px rgba(0, 0, 0, 0.2), 0px 13px 19px 2px rgba(0, 0, 0, 0.14), 0px 5px 24px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z14 {\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z15 {\n  box-shadow: 0px 8px 9px -5px rgba(0, 0, 0, 0.2), 0px 15px 22px 2px rgba(0, 0, 0, 0.14), 0px 6px 28px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z16 {\n  box-shadow: 0px 8px 10px -5px rgba(0, 0, 0, 0.2), 0px 16px 24px 2px rgba(0, 0, 0, 0.14), 0px 6px 30px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z17 {\n  box-shadow: 0px 8px 11px -5px rgba(0, 0, 0, 0.2), 0px 17px 26px 2px rgba(0, 0, 0, 0.14), 0px 6px 32px 5px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z18 {\n  box-shadow: 0px 9px 11px -5px rgba(0, 0, 0, 0.2), 0px 18px 28px 2px rgba(0, 0, 0, 0.14), 0px 7px 34px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z19 {\n  box-shadow: 0px 9px 12px -6px rgba(0, 0, 0, 0.2), 0px 19px 29px 2px rgba(0, 0, 0, 0.14), 0px 7px 36px 6px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z20 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 20px 31px 3px rgba(0, 0, 0, 0.14), 0px 8px 38px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z21 {\n  box-shadow: 0px 10px 13px -6px rgba(0, 0, 0, 0.2), 0px 21px 33px 3px rgba(0, 0, 0, 0.14), 0px 8px 40px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z22 {\n  box-shadow: 0px 10px 14px -6px rgba(0, 0, 0, 0.2), 0px 22px 35px 3px rgba(0, 0, 0, 0.14), 0px 8px 42px 7px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z23 {\n  box-shadow: 0px 11px 14px -7px rgba(0, 0, 0, 0.2), 0px 23px 36px 3px rgba(0, 0, 0, 0.14), 0px 9px 44px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation--z24 {\n  box-shadow: 0px 11px 15px -7px rgba(0, 0, 0, 0.2), 0px 24px 38px 3px rgba(0, 0, 0, 0.14), 0px 9px 46px 8px rgba(0, 0, 0, 0.12); }\n\n.mdc-elevation-transition {\n  transition: box-shadow 280ms cubic-bezier(0.4, 0, 0.2, 1);\n  will-change: box-shadow; }\n\n.grid {\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: (minmax(400px, 1fr))[auto-fill];\n      grid-template-columns: repeat(auto-fill, minmax(400px, 1fr));\n  grid-column-gap: 10px;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-rows: 130px;\n  margin: auto; }\n\n.slide-topright {\n  position: absolute;\n  top: 0;\n  right: -10px;\n  box-shadow: 0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 10px 14px 1px rgba(0, 0, 0, 0.14), 0px 4px 18px 3px rgba(0, 0, 0, 0.12);\n  z-index: 2; }\n\n.newElementButton {\n  width: 100px;\n  height: 100px;\n  position: absolute;\n  right: 5vw;\n  bottom: 7vh;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  font-size: 70px;\n  border-radius: 100%;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none; }\n\n.newElementButton:active {\n  -webkit-transform: scale(0.97);\n          transform: scale(0.97); }\n\n.left {\n  float: left;\n  -webkit-transform: translateY(8px);\n          transform: translateY(8px); }\n\n.right {\n  float: right; }\n\n.tile {\n  width: 400px;\n  height: 120px;\n  display: -ms-grid;\n  display: grid;\n  display: grid;\n  -ms-grid-columns: 5px 30% 1fr;\n      grid-template-columns: 5px 30% 1fr;\n  grid-column-gap: 0;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  box-shadow: 0px 2px 4px -1px rgba(0, 0, 0, 0.2), 0px 4px 5px 0px rgba(0, 0, 0, 0.14), 0px 1px 10px 0px rgba(0, 0, 0, 0.12);\n  position: relative;\n  border-radius: 2px;\n  font-family: \"Lato\";\n  box-sizing: border-box; }\n  .tile img {\n    width: 100px;\n    height: 100px;\n    justify-self: center;\n    -ms-flex-item-align: center;\n        -ms-grid-row-align: center;\n        align-self: center; }\n  .tile #details {\n    justify-self: stretch;\n    -ms-flex-item-align: stretch;\n        -ms-grid-row-align: stretch;\n        align-self: stretch;\n    padding: 5px; }\n  .tile #restaurant {\n    margin: auto;\n    padding: 10px;\n    font-size: 21px;\n    font-weight: 600; }\n  .tile .element {\n    width: 90%; }\n\n.tile:hover, .newElementButton:hover {\n  cursor: pointer;\n  box-shadow: 0px 5px 5px -3px rgba(0, 0, 0, 0.2), 0px 8px 10px 1px rgba(0, 0, 0, 0.14), 0px 3px 14px 2px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1.012) translateZ(0);\n          transform: scale(1.012) translateZ(0); }\n\n.tile:active, .newElementButton:active {\n  box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n  -webkit-transform: scale(1);\n          transform: scale(1); }\n\n.inactive {\n  pointer-events: none; }\n\n#close {\n  width: 105%;\n  height: 25px;\n  position: absolute;\n  right: 0;\n  bottom: 0px;\n  left: -10px;\n  margin: 10px auto 0;\n  font-size: 14px;\n  text-align: center; }\n  #close span {\n    position: relative;\n    top: -5px; }\n\n.wrapper {\n  width: 100%;\n  height: 100%;\n  display: -ms-grid;\n  display: grid;\n  -ms-grid-columns: 150px 30px 50px (100px)[3] 60px 1fr 150px 150px 20px;\n      grid-template-columns: 150px 30px 50px repeat(3, 100px) 60px 1fr 150px 150px 20px;\n  grid-column-gap: 0;\n  box-shadow: 0px 7px 9px -4px rgba(0, 0, 0, 0.2), 0px 14px 21px 2px rgba(0, 0, 0, 0.14), 0px 5px 26px 4px rgba(0, 0, 0, 0.12);\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: stretch;\n      justify-items: stretch;\n  position: -webkit-sticky;\n  position: sticky;\n  font-family: \"Lato\"; }\n\n.menuLink {\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  user-focus: none; }\n\n.menuLink:hover {\n  cursor: pointer; }\n\n#themes {\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  grid-auto-columns: 25px;\n  grid-auto-flow: column; }\n\n.theme {\n  width: 20px;\n  height: 20px;\n  border: solid 1px rgba(138, 138, 138, 0.3); }\n\n.theme:hover {\n  cursor: pointer; }\n\n.selected {\n  border: solid 1px rgba(22, 21, 23, 0.31); }\n\n#lunchWord {\n  font-weight: 800; }\n\n#lunchWord:hover, #masterWord:hover {\n  cursor: default; }\n\n#logo {\n  padding-left: 20px;\n  font-family: \"Lato\";\n  display: inline-block;\n  -ms-grid-column-align: center;\n      justify-items: center; }\n\n#userInfo {\n  display: -ms-grid;\n  display: grid;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-grid-column-align: center;\n      justify-items: center;\n  width: 150px;\n  font: \"Lato\"; }\n\n.inactive {\n  opacity: 0.2; }\n\n.inactive:hover {\n  cursor: default; }\n", ""]);
...
var DetailsComponent = (function () {
    ...
    DetailsComponent.prototype.showOrderDetails = function (index) {
        ...
        var absoluteX = buttonRect.left - 280;
